...
Última atualização: 2026-05-20 (Fase 3 do SIMS-MODE entregue — footprint consumido no snap, ancoragem floor/wall/ceiling no drop, inspector ganha seção "posicionamento" com dropdown custom de apoio; fix-ups: snap toggle com label fixo, cena starter alinhada, Bug 5 do QA)
