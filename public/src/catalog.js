...
export const tree = [
  {
    ...
    children: [
      ...
      { id: 'tv-stand', label: 'Rack de TV', query: 'tv stand', anchor: 'floor', footprint: [2, 1] },
      ...
      { id: 'ceiling-light', label: 'Luz de Teto', query: 'ceiling light', anchor: 'ceiling', footprint: [1, 1] },
      { id: 'chandelier', label: 'Lustre', query: 'chandelier', anchor: 'ceiling', footprint: [1, 1] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'desk-lamp', label: 'Abajur', query: 'desk lamp', anchor: 'floor', footprint: [1, 1] },
      { id: 'pendant-lamp', label: 'Luminária Pendente', query: 'pendant lamp', anchor: 'ceiling', footprint: [1, 1] },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'streetlight', label: 'Poste', query: 'street light', anchor: 'floor', footprint: [1, 1] },
